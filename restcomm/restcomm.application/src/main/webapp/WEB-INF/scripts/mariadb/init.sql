...
uncertainty_semi_major_axis VARCHAR(30),
uncertainty_semi_minor_axis VARCHAR(30),
angle_of_major_axis VARCHAR(30),
confidence VARCHAR(30),
altitude VARCHAR(30),
uncertainty_altitude VARCHAR(30),
inner_radius VARCHAR(30),
uncertainty_inner_radius VARCHAR(30),
offset_angle VARCHAR(30),
included_angle VARCHAR(30),
...
geofence_id VARCHAR(10),
geofence_event_type VARCHAR(20),
event_range BIGINT,
