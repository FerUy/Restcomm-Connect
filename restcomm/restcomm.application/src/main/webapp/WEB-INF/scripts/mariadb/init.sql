...
routing_area_code INTEGER,
location_number_address BIGINT,
network_entity_address BIGINT,
network_entity_name VARCHAR(254),
age_of_location_info INTEGER,
subscriber_state VARCHAR(50),
not_reachable_reason VARCHAR(20),
type_of_shape VARCHAR(60),
device_latitude VARCHAR(30),
device_longitude VARCHAR(30),
uncertainty DOUBLE,
uncertainty_semi_major_axis DOUBLE,
uncertainty_semi_minor_axis DOUBLE,
angle_of_major_axis DOUBLE,
confidence INTEGER,
altitude INTEGER,
uncertainty_altitude DOUBLE,
inner_radius INTEGER,
uncertainty_inner_radius DOUBLE,
offset_angle DOUBLE,
included_angle DOUBLE,
horizontal_speed VARCHAR(30),
vertical_speed VARCHAR(30),
uncertainty_horizontal_speed VARCHAR(30),
uncertainty_vertical_speed VARCHAR(30),
bearing VARCHAR(30),
deferred_location_event_type VARCHAR(30),
geofence_type VARCHAR(30),
geofence_id VARCHAR(30),
motion_event_range BIGINT,
civic_address VARCHAR(500),
