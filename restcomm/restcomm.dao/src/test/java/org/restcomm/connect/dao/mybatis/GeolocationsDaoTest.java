...
public class GeolocationsDaoTest {
    ...
    public void geolocationCreateReadUpdateDelete() {
        ...
        builder.setCi(12345);
        builder.setSac(12718);
        builder.setEnbid(334);
        ...
        assertTrue(result.getCi().equals(geolocation.getCi()));
        assertTrue(result.getSac().equals(geolocation.getSac()));
        assertTrue(result.getEnbid().equals(geolocation.getEnbid()));
        ...
        geolocation = geolocation.setCi(20210);
        geolocation = geolocation.setSac(13971);
        geolocation = geolocation.setEnbid(30021);
        ...
        geolocation = geolocation.setRac(32950);
    ...
    public void geolocationReadDeleteByAccountSid() {
        ...
        builder.setCi(12345);
        builder.setSac(2718);
        builder.setEnbid(21710);
        builder.setNetworkEntityAddress((long) 59848779);
        builder.setNetworkEntityName("msc59801");
        builder.setAgeOfLocationInfo(0);
        builder.setNetworkEntityName("assumedIdle");
        builder.setTac(13295);
        builder.setRac(13292);
